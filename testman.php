...
if(!isset($_SERVER['REQUEST_URI']) || !isset($_SERVER['REQUEST_METHOD'])){
	...
	if(isset($params['report'])){
		...
		\testman\Coverage::start($db,\testman\TestRunner::lib_dir(),array(\testman\TestRunner::lib_dir()));
	}
	if(isset($value)){
	...
	if($output_xml){
		ob_end_clean();
		\testman\TestRunner::output('xml',$params['xml']);
	}else{
...
<rt:template name="index">
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				<a class="brand" href="?view_mode={$view_mode}&db={$db}">Testman</a>
