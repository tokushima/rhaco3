...
\test\model\JoinA::create_table();

\test\model\JoinB::create_table();

\test\model\JoinC::create_table();

\test\model\JoinA::find_delete();
\test\model\JoinB::find_delete();
\test\model\JoinC::find_delete();
