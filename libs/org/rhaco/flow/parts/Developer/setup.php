...
if(isset($params['sqlite']) && !empty($params['sqlite'])){
	$dbc = new \org\rhaco\store\db\Dbc('{"type":"org.rhaco.store.db.module.Sqlite","dbname":"'.$params['sqlite'].'"}');
	
	if(isset($params['create_table']) && !empty($params['create_table'])){
...
}else if(isset($params['create_table'])){
